...
def main():
    ...
    with col1:
        st.image("./img.png", use_container_width=True)  # Updated parameter
    with col2:
        # Description
        st.markdown("""
    ...
    for feature in features:
        if feature == 'age':
            ...
            user_input[feature] = st.sidebar.selectbox('Chest Pain Type', options={
                'No Pain: 0',
                'Typical Angina: 1',
                'Atypical Angina: 2',
                'Non-Anginal Pain: 3',
            ...
            user_input[feature] = st.sidebar.selectbox('Fasting Blood Sugar > 120 mg/dl', options={
                'False: 0',
                'True: 1'
            }, index=0)
        elif feature == 'restecg':
            user_input[feature] = st.sidebar.selectbox('Resting Electrocardiographic Results', options={
                'Normal: 0',
            ...
            user_input[feature] = st.sidebar.selectbox('Exercise Induced Angina', options={
                'No: 0',
                'Yes: 1'
            }, index=0)
            ...
            user_input[feature] = st.sidebar.selectbox('Slope of Peak Exercise ST Segment', options={
                'Upsloping: 1',
                'Flat: 2',
                'Downsloping: 3'
            }, index=0)
            ...
            user_input[feature] = st.sidebar.selectbox('Thal', options={
                'Normal: 3',
                'Fixed Defect: 6',
                'Reversible Defect: 7'
            }, index=0)
    ...
    if st.sidebar.button('Predict'):
        ...
        # st.write(user_input)  # Optional: Uncomment for debugging
    ...
    ''', unsafe_allow_html=True)  # Contact information
